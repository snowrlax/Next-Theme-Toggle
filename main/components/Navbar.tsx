...
export const Navbar = () => {
    ...
    //                 <li><Link href={"/interative-page"}>Interactive Page</Link></li>
    //             </ul>
    //         </div>
    ...
    //             console.log("btn pressed " + toggleTheme)
    ...
    //             <li><Link href={"/"}>Home</Link></li>
    //             <li><Link href={"/static-page"}>Static Page</Link></li>
    //             <li><Link href={"/interactive-page"}>Interactive Page</Link></li>
    //         </ul>
    //     </div>

    // </div>

    return <div className="navbaar">
